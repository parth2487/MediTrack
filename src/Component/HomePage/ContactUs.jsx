...
const ContactUs = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log('Form submitted:', { firstName, email, subject, message });
  };

  return (
   <section class="mb-32">
    <h2 className="text-3xl font-bold text-center mb-8 wow animate__animated animate__fadeInUp">Contact Us</h2>
      <p className="text-lg text-gray-600 text-center mb-16 wow animate__animated animate__fadeInUp">Start growing in half the time with an all-in-one website builder - no more long hours spent on the boring stuff!</p>

  <div id="map" class="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat wow animate__animated animate__fadeInUp">
        <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11672.945750644447!2d-122.42107853750231!3d37.7730507907087!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858070cc2fbd55%3A0xa71491d736f62d5c!2sGolden%20Gate%20Bridge!5e0!3m2!1sen!2sus!4v1619524992238!5m2!1sen!2sus"
      width="70%" height="500" style={{border:"0",marginLeft:"342px"}} allowfullscreen="" loading="lazy"></iframe>
  </div>
  <div class="container px-6 md:px-12 wow animate__animated animate__fadeInUp">
    <div
